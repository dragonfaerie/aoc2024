...
private fun evaluateNumbers(answer: Long, input: List<String>): Boolean {
    ...
    fun evaluateAllCombinations(numbers: List<Long>, operators: List<String>, currentIndex: Int, currentResult: Long): Boolean {
        ...
        val newResult = when (nextOperator) {
            ...
            "*" -> currentResult * nextNumber
            "||" -> (currentResult.toString() + nextNumber.toString()).toLong()
...
private fun generateOperatorCombinations(length: Int): List<List<String>> {
